...
export const ELEMENT_TYPES = {
  ...
  bender: {
    ...
    fields: [
      ...
      { key: 'channelWidth', label: 'Beam channel', unit: 'mm', min: 2, max: 40, step: 0.5, rebuild: true, help: 'The clear straight-sided gap between neighbouring electrodes, on all four sides — the beam’s way in and out. It also sets the operating voltage: a wider channel cuts the electrode arcs shorter, and a shorter arc is a weaker quadrupole, so widening this raises the voltage needed for the same bend.' },
